...
public class CodeGenerator {
    ...
    // 模块名称
    private static String packageName = "/module/sys";
    // 表名，多个表中间用,隔开
    private static String tableName = "SysRole";
    /**
     * <p> 容易出错，改为配置读取
     * 读取控制台内容
     * </p>
    ...
    public static void main(String[] args) {
        ...
        String projectPath = "E:/idea-workspace/springboot-project/zz-admin";
        ...
        //在那个包下创建包
        pc.setParent("com.zz.springbootproject");
